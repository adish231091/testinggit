...
url = URI("http://#$Host:#$Port/#$ApiType/v1/#$TenantAccessKey/admin/job/ANALYTICS/Analytics/start")
puts "#{url}"
...
url=URI("http://#$Host:#$Port/#$ApiType/v1/#$TenantAccessKey/admin/jobsummaries?q=[{\"operator\":\"EQUALS\",\"attribute\":\"jobId\",\"value\":\"Analytics\"}]")
http = Net::HTTP.new(url.host, url.port);
...
while true
	...
	File.write("/Users/adishsharma/automation/regression_tenant100146/AnalyticsJobStatus.json", "#$MonitorJobStatus" , mode: "w") 
	puts "Fetching Publish Job Status from Admin API..."
	$Fread= File.read("/Users/adishsharma/automation/regression_tenant100146/AnalyticsJobStatus.json", mode: "r")
