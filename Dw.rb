...
url = URI("http://#$Host:#$Port/#$ApiType/v1/#$TenantAccessKey/admin/job/DW/Dw/start")
puts "#{url}"
...
url=URI("http://#$Host:#$Port/#$ApiType/v1/#$TenantAccessKey/admin/jobsummaries?q=[{\"operator\":\"EQUALS\",\"attribute\":\"jobId\",\"value\":\"Dw\"}]")
http = Net::HTTP.new(url.host, url.port);
...
while true
	...
	$Fread= File.read("/Users/adishsharma/automation/regression_tenant100146/DwJobStatus.json", mode: "r")
