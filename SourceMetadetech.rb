...
url = URI("http://#$Host:#$Port/#$ApiType/v1/#$TenantAccessKey/admin/job/SOURCESCHEMADETECT/Detect/start")
puts "#{url}"
...
url=URI("http://#$Host:#$Port/#$ApiType/v1/#$TenantAccessKey/admin/jobsummaries?q=[{\"operator\":\"EQUALS\",\"attribute\":\"jobId\",\"value\":\"Detect\"}]")
http = Net::HTTP.new(url.host, url.port);
...
while true
	...
	File.write("/Users/adishsharma/automation/regression_tenant100146/SourceMetaDetect.json", "#$MonitorJobStatus" , mode: "w") 
	puts "Fetching Publish Job Status from Admin API..."
	$Fread= File.read("/Users/adishsharma/automation/regression_tenant100146/SourceMetaDetect.json", mode: "r")
